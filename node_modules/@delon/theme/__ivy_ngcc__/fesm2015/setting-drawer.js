...
const DEFAULT_VARS = {
    'primary-color': { label: 'Color', type: 'color', default: '#1890ff' },
    ...
    'alain-default-header-padding': {
        label: 'Top Alignment -- Width',
        type: 'px',
        default: '16px'
    },
    // 侧边栏
    'alain-default-aside-wd': { label: 'Height', type: 'px', default: '200px' },
    ...
    'alain-default-aside-nav-text-color': {
        label: 'Navi Text Color',
        type: 'color',
        default: 'rgba(0, 0, 0, 0.65)',
        rgba: true
    },
    'alain-default-aside-nav-text-hover-color': {
        label: 'Navi Text Hover Color',
        type: 'color',
        default: '@primary-color',
        tip: '默认同主色系'
    },
    'alain-default-aside-nav-group-text-color': {
        label: 'av-group-text-color',
        type: 'color',
