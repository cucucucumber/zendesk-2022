...
function runOneOptions(workspace) {
    try {
        const workspaceConfigJson = (0, workspace_1.resolveNewFormatWithInlineProjects)((0, fileutils_1.readJsonFile)(path.join(workspace.dir, workspace.type === 'nx' ? 'workspace.json' : 'angular.json')));
        const nxJson = (0, fileutils_1.readJsonFile)(path.join(workspace.dir, 'nx.json'));
        return (0, parse_run_one_options_1.parseRunOneOptions)(workspace.dir, workspaceConfigJson, nxJson, process.argv.slice(2));
    }
    catch (_a) {
        return false;
    }
